...
function Modal() {
    ...
    // useRecoilState returns a tuple whereas useRecoilValue returns the value itself useRecoilState can also return both
    ...
    useEffect(() =>{
        ...
        fetchMovie()
    // call the function inside the useEffect but outside the function
    },[movie])
    console.log(trailer)
